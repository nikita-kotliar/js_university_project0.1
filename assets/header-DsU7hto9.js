(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function s(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=s(r);fetch(r.href,o)}})();async function Z(e,t,s,i=""){let r=`https://your-energy.b.goit.study/api/filters?filter=${e}&page=${t}&limit=${s}`;return i.trim()&&(r+=`&name=${i}`),(await fetch(r)).json()}async function ee(e,t,s,i,r){let o=e.toLowerCase();o==="body parts"&&(o="bodypart");const c=`
    ...
    &page=${i}
    &limit=${r}
  `.replace(/\s+/g,"");return(await fetch(c)).json()}async function te(e){const t=await fetch("https://your-energy.b.goit.study/api/subscription",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e})});if(t.status===409)throw new Error("EMAIL_EXISTS");if(!t.ok)throw new Error("REQUEST_FAILED");return await t.json()}async function O(){return(await fetch("https://your-energy.b.goit.study/api/quote")).json()}async function N(e,{email:t,rate:s,comment:i}){const r=`https://your-energy.b.goit.study/api/exercises/${e}/rating`;s=Number(s);const o=await fetch(r,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,rate:s,review:i})});if(!o.ok){const c=await o.json();throw new Error(c.message||"Rating failed")}return o.json()}const S="userFavorites",_="dailyQuote",w="quoteTimestamp",M=864e5,g=()=>{try{const e=localStorage.getItem(S);return e?JSON.parse(e):[]}catch(e){return console.error("Failed to load favorites:",e.message),[]}},E=e=>{localStorage.setItem(S,JSON.stringify(e))},j=e=>g().some(t=>t._id===e),A=e=>{const t=g();t.some(s=>s._id===e._id)||(t.push(e),E(t))},q=e=>{const t=g().filter(s=>s._id!==e);E(t)},P=e=>j(e._id)?(q(e._id),!1):(A(e),!0);async function C(){const e=localStorage.getItem(_),t=localStorage.getItem(w);if(e&&t&&Date.now()-Number(t)<M)return JSON.parse(e);try{const s=await O();return localStorage.setItem(_,JSON.stringify(s)),localStorage.setItem(w,Date.now().toString()),s}catch(s){return console.error("Failed to fetch daily quote:",s),e?JSON.parse(e):{text:"No quote available",author:"Unknown"}}}function D(e,t){return e.map(s=>{let{_id:i,name:r,burnedCalories:o,bodyPart:c,target:m,time:I=3,rating:T}=s,B=`${o} / ${I} min`;return`
        <li class="exercise-information" data-id-card="${i}">
          <div class="top-nav">
            ...
            <button data-action="start" data-id="${i}" class="details-link">
              Start
              <svg width="16" height="16">
                <use href="${t?"/js_university_project0.1/iconic.svg#icon-arrow":"/js_university_projectNew/symbol-defs.svg#icon-arrow"}"></use>
              </svg>
            </button>
          </div>
          ...
          <div class="exercise-header">
            <svg width="24" height="24">
              <use href="${t?"/js_university_project0.1/iconic.svg#icon-run":"/js_university_projectNew/symbol-defs.svg#icon-run"}"></use>
            </svg>
...
//# sourceMappingURL=header-DsU7hto9.js.map
